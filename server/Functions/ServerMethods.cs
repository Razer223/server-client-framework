...
namespace ServerFramework {
    ...
    class ServerMethods {
        public static string Test(ParameterClass dataClass) {
            Console.WriteLine($"MSG:{dataClass.Data} CLIENT: {dataClass.Client.Client.RemoteEndPoint} ID:{dataClass.Client.ID}");
